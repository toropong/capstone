...
<body>
    <form>
        <input id="login_id" type="text" placeholder="id" autocomplete="username" onkeypress="enterkey()" autofocus />
        <div id="login_blank"></div>
        <input id="login_pw" type="password" placeholder="password" autocomplete="current-password" onkeypress="enterkey()" />
